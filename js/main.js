...
function calculateSolar() {
	...
	var feedback="";
	feedback +="<p>Based on your avereage daily use of "+Math.round(dailyUseKw)+" kWh, you will need to purchase "+panelsNeeded+" "+panelName+" solar to offset 100% of your electricity bill.</p>";
